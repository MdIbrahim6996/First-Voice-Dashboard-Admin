...
exports.deleteAppliance = exports.updateAppliance = exports.getAppliancePerPage = exports.getAppliances = void 0;
...
var updateAppliance = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
                _a = req.body, name = _a.name, makeOfAppliance = _a.makeOfAppliance, age = _a.age;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, prismaClient_1.prisma.appliance.update({
                        where: { id: parseInt(id) },
                        data: {
                            name: name ? name : client_1.Prisma.skip,
                            makeOfAppliance: makeOfAppliance
                                ? makeOfAppliance
                                : client_1.Prisma.skip,
                            age: age ? parseInt(age) : client_1.Prisma.skip,
                            leadId: client_1.Prisma.skip,
                        },
                    })];
            case 2:
                appliance = _b.sent();
...
var deleteAppliance = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, appliance, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, prismaClient_1.prisma.appliance.delete({
                        where: { id: parseInt(id) },
                    })];
            case 2:
                appliance = _a.sent();
