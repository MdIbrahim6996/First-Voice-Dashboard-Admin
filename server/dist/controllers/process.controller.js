...
var createProcess = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var name_1, process_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                name_1 = req.body.name;
                return [4 /*yield*/, prismaClient_1.prisma.process.create({ data: { name: name_1 } })];
            case 1:
                process_1 = _a.sent();
                res.send(process_1);
                return [3 /*break*/, 3];
...
var getAllProcess = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var status_1, process_2, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, prismaClient_1.prisma.status.findMany({ select: { name: true } })];
            case 1:
                status_1 = _a.sent();
...
var getProcessInfo = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, time, date, results, status_2, startMonth_1, endMonth_1, counts, startYear_1, endYear_1, counts, process_3, grouped, processData, graphData_1, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
            ...
            case 2:
                ...
                counts = status_2 === null || status_2 === void 0 ? void 0 : status_2.map(function (item, i) { return __awaiter(void 0, void 0, void 0, function () {
                    var data;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
            ...
            case 7:
                process_3 = _a.sent();
                grouped = (0, lodash_1.groupBy)(process_3, function (record) {
                    return record.saleDate.toISOString().slice(5, 7);
                });
                processData = Object === null || Object === void 0 ? void 0 : Object.entries(grouped);
                graphData_1 = [];
                processData === null || processData === void 0 ? void 0 : processData.map(function (item) {
                    var success = 0;
                    var pending = 0;
                    var cancelled = 0;
                    var rework = 0;
...
var deleteProcess = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, process_4, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, prismaClient_1.prisma.process.delete({
...
var queryProcess = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, process_5, status_3, grouped, processData, result, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
            ...
            case 2:
                status_3 = _a.sent();
                grouped = (0, lodash_1.groupBy)(process_5, function (record) {
                    return record.saleDate.toISOString().slice(5, 7);
                });
                processData = Object === null || Object === void 0 ? void 0 : Object.entries(grouped);
                ...
                //     });
                // });
                result = date_1.timeArr === null || date_1.timeArr === void 0 ? void 0 : date_1.timeArr.map(function (item) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/];
                    });
                }); });
